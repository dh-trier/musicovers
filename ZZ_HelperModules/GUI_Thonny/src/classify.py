...
# same package
from src import classifyHelp, buildConfusionMatrix
...
sourcedatafile = join(workdir, "output", "chosen_features.csv")
targetdatafile = join(workdir, "output", "label_assignments.csv")
