...
targetdatafile = join(workdir, "8KL-daten", "8KL-010-neighbors.csv")
documentationfile = join(workdir, "8KL-daten", "8KL-010-neighbors.txt")
logfile = join(workdir, "8KL-daten", "8KL-log-010-neighbors.csv")
docstring = __doc__
