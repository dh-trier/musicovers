...
targetdatafile = join(workdir, "8KL-daten", "8KL-006-tree.csv")
documentationfile = join(workdir, "8KL-daten", "8KL-006-tree.txt")
logfile = join(workdir, "8KL-daten", "8KL-log-006-tree.csv")
docstring = __doc__
