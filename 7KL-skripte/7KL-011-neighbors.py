...
targetdatafile = join(workdir, "8KL-daten", "8KL-011-neighbors.csv")
documentationfile = join(workdir, "8KL-daten", "8KL-011-neighbors.txt")
logfile = join(workdir, "8KL-daten", "8KL-log-011-neighbors.csv")
docstring = __doc__
