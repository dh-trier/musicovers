...
Parameters:
Features tested: faces, objects, hsv values with 3 max values for H channel and max, std, median vor S and V channels, greyscale values
...
targetdatafile = join(workdir, "8KL-daten", "8KL-011-svm.csv")
documentationfile = join(workdir, "8KL-daten", "8KL-011-svm.txt")
logfile = join(workdir, "8KL-daten", "8KL-log-011-svm.csv")
docstring = __doc__
classifiertype = "svm"  # neighbors|svm|tree
kerneltype = "rbf"  # linear|poly|rbf
...
def get_featurematrix(data):
    ...
    all_columns = [faces_zs,hmax1_zs,hmax2_zs,hmax3_zs,smax1_zs,smed_zs,sstd,vmax1_zs,vmed_zs,vstd,comp_1,comp_2,comp_3,comp_4,comp_5,comp_6,comp_7,comp_8,comp_9,comp_10,comp_11,comp_12,comp_13,comp_14,comp_15,comp_16,comp_17,comp_18,comp_19,comp_20,comp_21,comp_22,comp_23,comp_24,comp_25, gray_max_zs,gray_med_zs,gray_std_zs]
...
def define_classifier(classifiertype, kerneltype):
    """
    ...
    if classifiertype == "svm":
        classifier = svm.SVC(kernel=kerneltype)  # linear|poly|rbf
