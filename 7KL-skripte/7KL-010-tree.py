...
targetdatafile = join(workdir, "8KL-daten", "8KL-010-tree.csv")
documentationfile = join(workdir, "8KL-daten", "8KL-010-tree.txt")
logfile = join(workdir, "8KL-daten", "8KL-log-010-tree.csv")
docstring = __doc__
