...
targetdatafile = join(workdir, "8KL-daten", "8KL-006-svm.csv")
documentationfile = join(workdir, "8KL-daten", "8KL-006-svm.txt")
logfile = join(workdir, "8KL-daten", "8KL-log-006-svm.csv")
docstring = __doc__
...
def perform_classification(featurematrix, genres, classifier):
    ...
    features_train, features_test, labels_train, labels_test = train_test_split(featurematrix, genres, test_size=100,random_state=None)
