...
targetdatafile = join(workdir, "8KL-daten", "8KL-006-neighbors.csv")
documentationfile = join(workdir, "8KL-daten", "8KL-006-neighbors.txt")
logfile = join(workdir, "8KL-daten", "8KL-log-006-neighbors.csv")
docstring = __doc__
