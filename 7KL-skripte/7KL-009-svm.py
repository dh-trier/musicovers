...
targetdatafile = join(workdir, "8KL-daten", "8KL-009-svm.csv")
documentationfile = join(workdir, "8KL-daten", "8KL-009-svm.txt")
logfile = join(workdir, "8KL-daten", "8KL-log-009-svm.csv")
docstring = __doc__
