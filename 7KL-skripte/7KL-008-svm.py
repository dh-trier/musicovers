...
targetdatafile = join(workdir, "8KL-daten", "8KL-008-svm.csv")
documentationfile = join(workdir, "8KL-daten", "8KL-008-svm.txt")
logfile = join(workdir, "8KL-daten", "8KL-log-008-svm.csv")
docstring = __doc__
