...
targetdatafile = join(workdir, "8KL-daten", "8KL-009-neighbors.csv")
documentationfile = join(workdir, "8KL-daten", "8KL-009-neighbors.txt")
logfile = join(workdir, "8KL-daten", "8KL-log-009-neighbors.csv")
docstring = __doc__
...
def log_scores(score):
    logstr = "{},{},{},{}\n".format(classifiertype, weights, n_neighbors, score)
