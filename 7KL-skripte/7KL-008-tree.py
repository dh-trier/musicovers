...
targetdatafile = join(workdir, "8KL-daten", "8KL-008-tree.csv")
documentationfile = join(workdir, "8KL-daten", "8KL-008-tree.txt")
logfile = join(workdir, "8KL-daten", "8KL-log-008-tree.csv")
docstring = __doc__
