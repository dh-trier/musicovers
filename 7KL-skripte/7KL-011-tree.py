...
targetdatafile = join(workdir, "8KL-daten", "8KL-011-tree.csv")
documentationfile = join(workdir, "8KL-daten", "8KL-011-tree.txt")
logfile = join(workdir, "8KL-daten", "8KL-log-011-tree.csv")
docstring = __doc__
