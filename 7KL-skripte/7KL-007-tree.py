...
targetdatafile = join(workdir, "8KL-daten", "8KL-007-tree.csv")
documentationfile = join(workdir, "8KL-daten", "8KL-007-tree.txt")
logfile = join(workdir, "8KL-daten", "8KL-log-007-tree.csv")
docstring = __doc__
