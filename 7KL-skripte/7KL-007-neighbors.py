...
targetdatafile = join(workdir, "8KL-daten", "8KL-007-neighbors.csv")
documentationfile = join(workdir, "8KL-daten", "8KL-007-neighbors.txt")
logfile = join(workdir, "8KL-daten", "8KL-log-007-neighbors.csv")
docstring = __doc__
