...
targetdatafile = join(workdir, "8KL-daten", "8KL-007-svm.csv")
documentationfile = join(workdir, "8KL-daten", "8KL-007-svm.txt")
logfile = join(workdir, "8KL-daten", "8KL-log-007-svm.csv")
docstring = __doc__
...
print('benutzter Kerneltype:', kerneltype)
...
def define_classifier(classifiertype, kernel):
    ...
    if classifiertype == "svm":
        ...
        if kernel == "poly":
            cache_s = 1000
        classifier = svm.SVC(kernel=kernel, cache_size=cache_s)  # linear|poly|rbf
