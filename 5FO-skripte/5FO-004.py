...
sourcedatafile = join(workdir, "4FE-daten", "4FE-005.csv")
targetdatafile = join(workdir, "6FO-daten", "6FO-004.csv")
documentationfile = join(workdir, "6FO-daten", "6FO-004.txt")
docstring = __doc__
